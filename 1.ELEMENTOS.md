...
El sofware de sistema (software basico para que funcione un equipo), Desarrollados en leguaje C.
El software de aplicacion, software para trabajar.
El software de desarrollo, es un software para usuarios especificos.
...
Son los elementos basicos de un equipo informático.
...
El codigo fuente debe estar en texto plano.
En java el codigo objeto no es nativo, por lo que nesecita una maquina virtual de java.

## Ciclo de vida del software
Abarca desde que se idea una aplicación, hasta  que la aplicación queda obsoleta, y no se utiliza.
...
- La especificación de requisitos debe:
  ...
  - Evitar ambigüedades. Hay que ser muy especifico con lo que se quiere
  - Evitar detalles de diseño o implementación
  - Ser entendible por el cliente
  - Separar requisitos funcionales y no funcionales. Por ejemplo: que no consuma mucho de la CPU(no funcinal)
  - Dividir y jerarquizar el modelo
  - Fijar criterios de validación. Hacer una aplicación que es la que pide el usuario.
...
- Las actividades habituales son las siguientes:
  - Diseño arquitectónico: Diseño de los componentes 
  - Diseño detallado
  - Diseño de datos
  - Diseño de interfaz
...
ingenieria de sistema: tipo se sistema en el que se va a utilizar la aplicación
...
pruebas de unidades: probar las clases
prueba integración: mezclar unas clases con otras y comprobar que funciona correctamente
prueba de sistema: por ejemplo comprobar cuantos usuarios puede soportar la aplición
documentación: documentación acerca de las pruebas realizadas, manuales para los usuarios
mantenimiento: cambios que le vamos haciendo en la aplicación
...
Vefiricar: que funciona correctamente
validar: que se esta desarrollando como nos indican los requisitos del usuario
### Prototipos (I)
...
Se contruye un modelo ejemplo de la aplicación, hasta que el cliente deja claro que es lo que quiere.
...
- Son métodos de ingeniería del software basados en el desarrollo iterativo e incremental. Siempre va mejorando
- Los requisitos y soluciones evolucionan con el tiempo según la necesidad del proyecto.Se van añadiendo nuevos requisitos en el analisis para la mejora de las aplicaciones.
- El trabajo es realizado mediante la colaboración de equipos auto-organizados y multidisciplinarios, inmersos en un proceso compartido de toma de decisiones a corto plazo. El trabajo es organizado con alguien y en distintas disciplinas, y toma de decisiones en equipo.
...
- __Individuos e interacciones__ sobre procesos y herramientas. Es mas importante el equipo de programadores, que los procesos y herramientas
- __Software funcionando__ sobre documentación extensiva. Se le da menos importancia a la dacumentación, lo importante es que el software funcione correctamente 
- __Colaboración con el cliente__ sobre negociación contractual. El cliente puede ir modificando los requisitos
- __Respuesta ante el cambio__ sobre seguir un plan. La importancia de irte adaptando a los cambios


#### __Kanban (I)__

- También se denomina "sistema de tarjetas".
Trabaja con etiquetas para saber el destino del producto
...
- Fabricación bajo demanda con los requisitos justos.
...
- Para obtener código binario ejecutable tenemos 2 opciones:
  - __Compilar__. Cuando se compila se obtiene un archivo ejecutable.
  - __Interpretar__. No genera archivo ejecutable.


### Proceso de compilación/interpretación

- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__. Equivalente a comprobar la ortografía.
  2. __Análisis sintáctico__. Comprobar que las palabras están en el orden correcto.
...
- Ejemplos: C, C++
- Principal ventaja: Ejecución muy eficiente. Se ejecutan muy rapido.
...
- El código fuente Java __se compila__ y se obtiene un código binario intermedio denominado __bytecode__. Es el codigo .class que interpreta la maquina virtual java.
...
- Desventajas:
  - Menos eficiente que los lenguajes compilados. La ejecución es mas lenta y aprovecha menos los recursos del ordenador.
...
- Tipos de __lenguajes declarativos__:(Estos lenguajes son de poco uso en la actualidad, salvo SQL)
...
- Tipos de lenguajes según nivel de abstracción: Según el codigo que se escribe, más abstracción menos código, menos abstracción más código.
...
- Código binario, solo 0 y 1
- Ensamblador, trabaja con lenguaje nemotécnico que luego se traduce a codigo binario. 
- Lenguajes estructurados
- Lenguajes orientados a objetos. Mejora los lenguajes estructurados.
...
- Campo de aplicación. Tipo de programa que se va a desarrollar(Escritorio, sistema empotrado(cpu coche, lavadora,...), ...)
- Experiencia previa
- Herramientas de desarrollo. Compiladores, IDE's
- Documentación disponible
- Base de usuarios
- Reusabilidad. Ej: Uso de bibliotecas.
- Transportabilidad. Que funcione en distintas plataformas
